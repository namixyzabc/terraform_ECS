...
resource "aws_security_group" "nat" {
  name        = "${var.env}-nat-sg"
  description = "Allow traffic to NAT instance"
  vpc_id      = aws_vpc.main.id
...
resource "aws_security_group" "bastion" {
  ...
  ingress {
    ...
    to_port     = 22
    protocol    = "tcp"
    cidr_blocks = ["0.0.0.0/0"] # Replace with your IP address for better security
  }
...
resource "aws_s3_bucket" "main" {
  bucket = "${var.env}-app-assets-${random_id.bucket_suffix.hex}"
